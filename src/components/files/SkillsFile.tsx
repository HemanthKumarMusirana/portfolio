...
const skillsData = [
  {
    ...
    items: [
      ...
      { name: "Python", percent: 70, color: "#ff79c6" },
      { name: "C++", percent: 80, color: "#4fc1ff" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Spring Boot", percent: 75, color: "#16A34A" },
      { name: "Django", percent: 70, color: "#22c55e" },
      { name: "Flask", percent: 65, color: "#facc15" }
    ]
  },
  {
    title: "Cloud & DevOps",
    items: [
      { name: "AWS", percent: 80, color: "#f97316" },
      { name: "CI/CD Pipelines", percent: 80, color: "#a855f7" },
      { name: "Azure", percent: 70, color: "#4fc1ff" },
      { name: "GCP", percent: 70, color: "#fbbc04" },
  ...
  },
  {
    title: "Databases",
    items: [
      { name: "PostgreSQL", percent: 78, color: "#4fc1ff" },
      { name: "MySQL", percent: 70, color: "#c586c0" },
      { name: "Redis", percent: 69, color: "#dc2626" }
    ]
  },
  {
    title: "Artificial Intelligence & Data Science",
    items: [
      { name: "PyTorch", percent: 88, color: "#f97316" },
      { name: "TensorFlow", percent: 85, color: "#ff79c6" },
      { name: "Pandas & NumPy", percent: 85, color: "#4fc1ff" },
      { name: "LLM Fine-Tuning", percent: 85, color: "#a855f7" },
      { name: "Grad-CAM (XAI)", percent: 82, color: "#22c55e" }
    ]
  },
  {
    title: "Systems & Core CS Concepts",
    items: [
      ...
      { name: "Kernel Fundamentals", percent: 75, color: "#facc15" }
    ]
  }
];

            ...
            >
              ...
              {menu === 'File' && isFileMenuOpen && (
                ...
                >
                  ...
                  <a href="/Hemanth_Kumar_Resume.pdf" target="_blank" rel="noopener noreferrer" className="px-6 py-1.5 hover:bg-[#04395e] cursor-pointer block text-inherit no-underline transition-colors" onClick={() => setIsFileMenuOpen(false)}>
                    Download Resume
                  </a>
                </div>
              )}
